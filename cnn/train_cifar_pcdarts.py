...
'''
  https://github.com/yuhuixu1993/PC-DARTS/issues/7
     hi, as we all know, the training results on CIFAR-10 may have high variance, so we need to train more times to use the mean of them. Besides，the high variance will also influence the search process including both DARTS and our method which means that we can not search the best result each time, while our method is more stable than DARTS. According to our experiments, 
     most of the results fall into (97.30,97.45)!!!
